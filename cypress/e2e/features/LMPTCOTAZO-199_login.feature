Feature: Login page
    ...
    Scenario: Verify failed login lockout attempts
        When The user creates an invalid email and password
        And The user enters an invalid password 5 times in a row with "email"
        ...
        When The user repeats wrong login 5 times after the first lockout with "email"
        Then The user verifies that the login is blocked
